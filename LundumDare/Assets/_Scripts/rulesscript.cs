...
public class rulesscript : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(Screen.width / 2 - 200, 200, 500, 25), "Stay alive - You have 3 life", myStyle2);
        ...
        GUI.Label(new Rect(Screen.width / 2 - 200, 320, 500, 25), "Take GREEN seed to get a bonus", myStyle2);
        GUI.Label(new Rect(Screen.width / 2 - 200, 350, 500, 25), "Care RED seed give you malus", myStyle2);
        GUI.Label(new Rect(Screen.width / 2 - 50, 390, 500, 30), "C O N T R O L", myStyle);
        GUI.Label(new Rect(Screen.width / 2 - 200, 440, 700, 25), "Press X for left or double X to dash on the left", myStyle2);
        GUI.Label(new Rect(Screen.width / 2 - 200, 470, 700, 25), "Press C for right or double C for dash on the right", myStyle2);
